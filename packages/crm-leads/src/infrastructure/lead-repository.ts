...
export interface ILeadRepository {
  create(data: CreateLeadInput, tx?: Prisma.TransactionClient): Promise<{ id: string }>;
...
export class LeadRepository implements ILeadRepository {
  ...
  async create(data: CreateLeadInput, tx?: Prisma.TransactionClient): Promise<{ id: string }> {
