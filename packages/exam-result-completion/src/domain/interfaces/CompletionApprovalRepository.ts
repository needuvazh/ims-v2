import { CompletionApproval, ApprovalLevel, ApprovalStatus } from '../aggregates/CompletionApproval';
...
export interface CompletionApprovalRepository {
  ...
  findByCompletionAndLevel(completionId: string, level: ApprovalLevel): Promise<CompletionApproval | null>;
  findByActorAndStatus(actorId: string, status: ApprovalStatus): Promise<CompletionApproval[]>;
