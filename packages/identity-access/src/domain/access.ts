...
export const adminNavigation: NavigationItem[] = [
  ...
  },
  {
    ...
    category: 'Operations',
    items: [
      { href: '/attendance/dashboard', label: 'Attendance Dashboard', permission: 'attendance.dashboard.view' },
      { href: '/attendance/sessions', label: 'Sessions', permission: 'attendance.sessions.menu.view' },
      { href: '/attendance/records', label: 'Records', permission: 'attendance.records.menu.view' },
      { href: '/attendance/corrections', label: 'Corrections', permission: 'attendance.corrections.menu.view' },
      { href: '/attendance/reports', label: 'Reports', permission: 'attendance.reports.menu.view' },
    ],
  },
  {
    href: '/organization',
  ...
  },
  {
    ...
    category: 'Operations',
    items: [
      { href: '/exam-completion/dashboard', label: 'Dashboard', permission: 'exam.view' },
      { href: '/exam-completion/exams', label: 'Exams', permission: 'exam.view' },
      { href: '/exam-completion/results', label: 'Results', permission: 'result.view' },
