...
export class TrainerManagementService {
  ...
  async createTrainerProfile(
    input: Parameters<TrainerManagementRepository['createTrainerProfile']>[0],
    context: AuthContext,
  ) {
    ensurePermission(context, 'trainer.create');
    ensureBranchScope(context, input.branchId);
    const existing = await this.repository.findTrainerByPersonId(
      input.personId,
    );
    if (existing) {
      throw new DomainError(
        'conflict',
        'Trainer profile already exists for this person.',
      );
    }
    return this.repository.createTrainerProfile({
      ...input,
  ...
  async updateTrainerProfile(
    trainerId: string,
    input: Parameters<TrainerManagementRepository['updateTrainerProfile']>[1],
    context: AuthContext,
  ) {
  ...
  async createQualification(
    trainerId: string,
    input: Parameters<TrainerManagementRepository['createQualification']>[1],
    context: AuthContext,
  ) {
  ...
  async updateQualification(
    ...
    input: Parameters<TrainerManagementRepository['updateQualification']>[2],
    context: AuthContext,
  ) {
    ensurePermission(context, 'trainer.qualification.manage');
  ...
  async deleteQualification(
    ...
    ensurePermission(context, 'trainer.qualification.manage');
    return this.repository.deleteQualification(
      trainerId,
      qualificationId,
      reason,
      version,
  ...
  async createAvailability(
    trainerId: string,
    input: Parameters<TrainerManagementRepository['createAvailability']>[1],
    context: AuthContext,
  ) {
  ...
  async updateAvailability(
    ...
    input: Parameters<TrainerManagementRepository['updateAvailability']>[2],
    context: AuthContext,
  ) {
    ensurePermission(context, 'trainer.availability.manage');
  ...
  async deleteAvailability(
    ...
    ensurePermission(context, 'trainer.availability.manage');
    return this.repository.deleteAvailability(
      trainerId,
      availabilityId,
      reason,
      version,
  ...
  async validateAvailability(
    ...
    return this.repository.validateAvailability(
      trainerId,
      branchId,
      date,
      startTime,
  ...
  async createAuthorization(
    trainerId: string,
    input: Parameters<TrainerManagementRepository['createAuthorization']>[1],
    context: AuthContext,
  ) {
  ...
  async transitionAuthorization(
    ...
    ensurePermission(context, 'trainer.authorization.manage');
    return this.repository.transitionAuthorization(
      trainerId,
      authorizationId,
      input,
    );
  ...
  async createCompensationRate(
    trainerId: string,
    input: Parameters<TrainerManagementRepository['createCompensationRate']>[1],
    context: AuthContext,
  ) {
  ...
  async updateCompensationRate(
    trainerId: string,
    rateId: string,
    input: Parameters<TrainerManagementRepository['updateCompensationRate']>[2],
    context: AuthContext,
  ) {
    ensurePermission(context, 'trainer.compensation.manage');
