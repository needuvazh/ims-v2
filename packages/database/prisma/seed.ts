...
const systemPermissions = [
  ...
  { moduleCode: 'enrollment',   featureCode: 'student',     actionCode: 'create', permissionCode: 'student.create',                 permissionType: 'Action' as const, description: 'Create student profiles.' },
  { moduleCode: 'enrollment',   featureCode: 'student',     actionCode: 'update', permissionCode: 'student.update',                 permissionType: 'Action' as const, description: 'Update student profiles.' },
  { moduleCode: 'enrollment',   featureCode: 'student',     actionCode: 'status.change', permissionCode: 'student.status.change',  permissionType: 'Action' as const, description: 'Change student lifecycle status.' },
  { moduleCode: 'enrollment',   featureCode: 'student',     actionCode: 'archive', permissionCode: 'student.archive',               permissionType: 'Action' as const, description: 'Archive student profiles.' },
  { moduleCode: 'enrollment',   featureCode: 'student',     actionCode: 'restore', permissionCode: 'student.restore',               permissionType: 'Action' as const, description: 'Restore archived student profiles.' },
  { moduleCode: 'enrollment',   featureCode: 'student',     actionCode: 'idcard.manage', permissionCode: 'student.idcard.manage',     permissionType: 'Action' as const, description: 'Issue and manage student ID cards.' },
  { moduleCode: 'enrollment',   featureCode: 'student',     actionCode: 'duplicate.read', permissionCode: 'student.duplicate.read',   permissionType: 'Action' as const, description: 'View duplicate review cases.' },
  { moduleCode: 'enrollment',   featureCode: 'student',     actionCode: 'duplicate.resolve', permissionCode: 'student.duplicate.resolve', permissionType: 'Action' as const, description: 'Resolve duplicate review cases.' },
  { moduleCode: 'enrollment',   featureCode: 'student',     actionCode: 'merge',   permissionCode: 'student.merge',                  permissionType: 'Action' as const, description: 'Merge duplicate student profiles.' },
  { moduleCode: 'enrollment',   featureCode: 'student',     actionCode: 'export',  permissionCode: 'student.export',                 permissionType: 'Action' as const, description: 'Export student data.' },
  { moduleCode: 'enrollment',   featureCode: 'student',     actionCode: 'audit.read', permissionCode: 'student.audit.read',           permissionType: 'Action' as const, description: 'Read student audit trails.' },
  { moduleCode: 'enrollment',   featureCode: 'student',     actionCode: 'identity.unmasked.read', permissionCode: 'student.identity.unmasked.read', permissionType: 'Action' as const, description: 'View unmasked student identity fields.' },
  { moduleCode: 'enrollment',   featureCode: 'student',     actionCode: 'portal.self.read', permissionCode: 'student.portal.self.read',     permissionType: 'Action' as const, description: 'Student portal self-view.' },
  { moduleCode: 'enrollment',   featureCode: 'student',     actionCode: 'trainer.roster.read', permissionCode: 'student.trainer.roster.read', permissionType: 'Action' as const, description: 'Trainer roster quick view.' },
  { moduleCode: 'enrollment',   featureCode: 'student',     actionCode: 'related.admission.read', permissionCode: 'student.related.admission.read', permissionType: 'Action' as const, description: 'Read linked admission summary.' },
  { moduleCode: 'enrollment',   featureCode: 'student',     actionCode: 'related.enrollment.read', permissionCode: 'student.related.enrollment.read', permissionType: 'Action' as const, description: 'Read linked enrollment summary.' },
  { moduleCode: 'enrollment',   featureCode: 'student',     actionCode: 'related.document.read', permissionCode: 'student.related.document.read', permissionType: 'Action' as const, description: 'Read linked document summary.' },
