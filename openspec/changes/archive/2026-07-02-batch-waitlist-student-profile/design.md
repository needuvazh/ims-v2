...
- We will **keep `Promoted` as the terminal reservation state** in the waitlist status state machine. We will _not_ introduce a new `'Resolved'` status to the database.
