...
- [x] 4.1 Add a session management screen for listing active sessions and terminating one or all sessions for a user
- [x] 4.2 Add a security policy screen for viewing and editing IAM security policy values
- [x] 4.3 Add a login history screen for browsing authentication attempts and lockout-related activity
...
- [x] 5.3 Add report export job status and download affordances
...
- [x] 6.1 Add UI tests for the portal shell, navigation visibility, and branch context display
- [x] 6.2 Add UI tests for users, roles, permissions, sessions, and security policy screens
- [x] 6.3 Add UI tests for audit, reports, dashboard, empty states, and validation failures
- [x] 6.4 Verify keyboard navigation, focus order, and responsive behavior for the new IAM screens
- [x] 6.5 Run the affected portal typecheck, lint, and build checks
- [x] 6.6 Update `docs/project-status.md` or the relevant implementation status note if the IAM UI phase materially changes completion tracking
...
- [x] 7.3 Update the login screen to support a "Remember me" checkbox and gracefully display concurrent session limit (`IAM-AUTH-008`) errors
- [x] 7.4 Ensure public screens properly redirect to the portal upon successful completion
- [x] 7.5 Add an authenticated "Change Password" screen to the portal user profile/settings area
