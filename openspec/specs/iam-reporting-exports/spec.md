# Specification: IAM Reporting & Exports

## Purpose
Define requirements for operational, compliance, audit, and dashboard reports, export formats, and permission-based scopes for accessing report data.
