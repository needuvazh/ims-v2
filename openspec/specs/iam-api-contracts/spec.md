# Specification: IAM API Contracts

## Purpose
Document the REST API contract details for all Identity and Access Management (IAM) endpoints under `/api/v1`, mapping to RFC7807 error envelopes, rate limits, localization, and middleware requirements.
