...
This specification defines the requirements and scenarios for dynamic CRM Dashboard reporting, permission-aware filtering of metrics, and audit logging for ASTI IMS.
