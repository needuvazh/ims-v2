...
- **Table Columns & Behaviors:**
  ...
  - _Paging:_ 25, 50, 100 rows per page. Standard cursor-based paging controls.
...
- **Tab 1: Pricing Configurations:**
  ...
  - _Grid List Columns:_ Branch Scope, Customer Type, Price, Tax, Start Date, End Date, Status.
- **Tab 2: Completion Rules:**
  - _Form Fields:_
    ...
    - `Effective Start Date` (Date, mandatory)
  - _History List:_ Timeline tracker detailing old rules and dates deactivated.
...
- **Layout & Grid Structure:**
  ...
  - Three columns layout below header:
    - _Left column (col-span-8):_ Tabs for Active Students Roster, Timetable Schedule, and Attendance Summaries.
    - _Right column (col-span-4):_ Waitlist Queue Manager widget and Trainer allocation card.
