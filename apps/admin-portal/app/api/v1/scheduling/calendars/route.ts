    ...
    async () =>
      withPermission(
        ...
        async ({ session }) => {
          ...
          try {
            const data = await schedulingCalendarService.listCalendars(
              parsed.data,
            );
            ...
            logger.error('api.scheduling.calendars.list.failed', {
              status: 'failed',
    ...
    async () =>
      withPermission(
        ...
        async ({ session }) => {
          ...
          try {
            const created =
              await schedulingCalendarService.createBusinessCalendar(
                parsed.data as CreateBusinessCalendarCommand,
                {
            ...
            logger.error('api.scheduling.calendars.create.failed', {
              status: 'failed',
              error: error as Error,
              userId: session.userId,
            });
