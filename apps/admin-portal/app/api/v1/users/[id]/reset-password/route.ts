...
function problemJson(
  ...
  return NextResponse.json(
    {
      type: 'https://ims.local/problems/user-reset-password',
      title,
      status,
      detail,
      errorCode,
  ...
  return withRouteObservability(
    ...
    async () => {
      ...
      try {
        ...
        await userService.adminResetPassword(params.id, {
        ...
        logger.info('api.users.resetPassword.succeeded', {
          status: 'success',
          userId: params.id,
        });
        return response;
        ...
        logger.error('api.users.resetPassword.failed', {
          status: 'failed',
        ...
        return problemJson(
          500,
          'Admin reset failed',
          'Unable to request a password reset at this time.',
          'IAM-USER-RESET-FAILED',
        );
      }
    },
    { route: '/api/v1/users/:id/reset-password' },
