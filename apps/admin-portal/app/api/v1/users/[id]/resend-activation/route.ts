  ...
  return withRouteObservability(
    ...
    async () => {
      ...
      try {
        ...
        logger.info('api.users.resendActivation.succeeded', {
          status: 'success',
          userId: params.id,
        });
        return response;
        ...
        logger.error('api.users.resendActivation.failed', {
          status: 'failed',
        ...
        return problemJson(
          500,
          'Activation resend failed',
          'Unable to resend activation email at this time.',
          'IAM-USER-RESEND-ACTIVATION-FAILED',
        );
      }
    },
    { route: '/api/v1/users/:id/resend-activation' },
