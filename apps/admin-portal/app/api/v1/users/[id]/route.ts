  ...
  return withRouteObservability(
    ...
    async () => {
      ...
      try {
        ...
        logger.info('api.users.get.succeeded', {
          status: 'success',
          userId: params.id,
        });
        return response;
        ...
        logger.error('api.users.get.failed', {
          status: 'failed',
        ...
        return problemJson(
          500,
          'User detail failed',
          'Unable to load the user at this time.',
          'IAM-USERS-GET-FAILED',
        );
      }
    },
    { route: '/api/v1/users/:id' },
    ...
    async () => {
      ...
      try {
        ...
        return problemJson(
          ...
          'IAM-VAL-USER-UPDATE-INVALID_JSON',
        );
      }
      ...
      try {
        ...
        logger.info('api.users.update.succeeded', {
          status: 'success',
          userId: params.id,
        });
        return response;
        ...
        logger.error('api.users.update.failed', {
          status: 'failed',
          error: error as Error,
          userId: params.id,
        });
        return problemJson(
          500,
          'User update failed',
          'Unable to update the user at this time.',
          'IAM-USERS-UPDATE-FAILED',
        );
      }
    },
    { route: '/api/v1/users/:id' },
