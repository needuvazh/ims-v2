...
function problemJson(
  ...
  return NextResponse.json(
    {
      type: 'https://ims.local/problems/user-roles',
      title,
      status,
      detail,
      errorCode,
  ...
  return withRouteObservability(
    ...
    async () => {
      ...
      try {
        ...
        logger.info('api.users.roles.list.succeeded', {
          status: 'success',
          userId: params.id,
        });
        return response;
        ...
        logger.error('api.users.roles.list.failed', {
          status: 'failed',
        ...
        return problemJson(
          500,
          'User roles failed',
          'Unable to load user roles at this time.',
          'IAM-USER-ROLES-FAILED',
        );
      }
    },
    { route: '/api/v1/users/:id/roles' },
    ...
    async () => {
      ...
      try {
        ...
        return problemJson(
          ...
          'IAM-VAL-USER-ROLE-INVALID_JSON',
        );
      }
      ...
      if (!parsed.success) {
        return problemJson(
          ...
          'IAM-VAL-USER-ROLE-INVALID_BODY',
      ...
      try {
        ...
        logger.info('api.users.roles.assign.succeeded', {
          status: 'success',
          userId: params.id,
        ...
        logger.error('api.users.roles.assign.failed', {
          status: 'failed',
          error: error as Error,
          userId: params.id,
        });
        return problemJson(
          500,
          'Role assignment failed',
          'Unable to assign role at this time.',
          'IAM-USER-ROLE-ASSIGN-FAILED',
        );
      }
    },
    { route: '/api/v1/users/:id/roles' },
