...
function problemJson(
  ...
  return NextResponse.json(
    {
      type: 'https://ims.local/problems/audit-export',
      title,
      status,
      detail,
      errorCode,
    ...
    async () => {
      ...
      if (!parsed.success) {
        return problemJson(
          ...
          'IAM-VAL-AUDIT-EXPORT-INVALID_BODY',
      ...
      try {
        ...
        logger.info('api.audit.export.succeeded', {
          status: 'success',
          exportJobId: job.id,
        });
        return response;
        ...
        logger.error('api.audit.export.failed', {
          status: 'failed',
        ...
        return problemJson(
          500,
          'Audit export failed',
          'Unable to create audit export at this time.',
          'IAM-AUDIT-EXPORT-FAILED',
        );
      }
    },
    { route: '/api/v1/audit/export' },
