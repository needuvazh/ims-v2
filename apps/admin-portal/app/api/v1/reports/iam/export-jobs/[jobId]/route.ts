...
function problemJson(
  ...
  return NextResponse.json(
    {
      type: 'https://ims.local/problems/export-job',
      title,
      status,
      detail,
      errorCode,
  ...
  return withRouteObservability(
    ...
    async () => {
      ...
      try {
        ...
        logger.info('api.exportJobs.get.succeeded', {
          status: 'success',
        ...
        logger.error('api.exportJobs.get.failed', {
          status: 'failed',
        ...
        return problemJson(
          500,
          'Export job lookup failed',
          'Unable to load export job at this time.',
          'IAM-EXPORT-JOB-FAILED',
        );
      }
    },
    { route: '/api/v1/reports/iam/export-jobs/:jobId' },
