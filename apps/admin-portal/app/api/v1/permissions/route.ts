...
function problemJson(
  ...
  return NextResponse.json(
    {
      type: 'https://ims.local/problems/permissions',
      title,
      status,
      detail,
      errorCode,
      ...
      try {
        ...
        if (!parsed.success) {
          return problemJson(
            ...
            'IAM-VAL-PERMISSIONS-INVALID_QUERY',
        ...
        logger.error('api.permissions.list.failed', {
          status: 'failed',
        ...
        return problemJson(
          500,
          'Permission list failed',
          'Unable to load permissions at this time.',
          'IAM-PERMISSIONS-LIST-FAILED',
        );
      }
    },
    { route: '/api/v1/permissions' },
