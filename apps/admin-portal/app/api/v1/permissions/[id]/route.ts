...
function problemJson(
  ...
  return NextResponse.json(
    {
      type: 'https://ims.local/problems/permission-detail',
      title,
      status,
      detail,
      errorCode,
  ...
  return withRouteObservability(
    ...
    async () => {
      ...
      try {
        ...
        logger.info('api.permissions.get.succeeded', {
          status: 'success',
        ...
        logger.error('api.permissions.get.failed', {
          status: 'failed',
        ...
        return problemJson(
          500,
          'Permission detail failed',
          'Unable to load permission at this time.',
          'IAM-PERMISSIONS-GET-FAILED',
        );
      }
    },
    { route: '/api/v1/permissions/:id' },
    ...
    async () => {
      ...
      try {
        ...
        return problemJson(
          ...
          'IAM-VAL-PERMISSION-INVALID_JSON',
        );
      }
      ...
      if (!parsed.success) {
        return problemJson(
          400,
          'Invalid request body',
          'Permission update is invalid.',
          'IAM-VAL-PERMISSION-INVALID_BODY',
      ...
      try {
        ...
        logger.info('api.permissions.update.succeeded', {
          status: 'success',
          permissionId: params.id,
        });
        return response;
        ...
        logger.error('api.permissions.update.failed', {
          status: 'failed',
          error: error as Error,
          permissionId: params.id,
        });
        return problemJson(
          500,
          'Permission update failed',
          'Unable to update permission at this time.',
          'IAM-PERMISSIONS-UPDATE-FAILED',
        );
      }
    },
    { route: '/api/v1/permissions/:id' },
