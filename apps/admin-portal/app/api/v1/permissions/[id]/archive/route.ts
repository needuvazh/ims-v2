...
function problemJson(
  ...
  return NextResponse.json(
    {
      type: 'https://ims.local/problems/permission-archive',
      title,
      status,
      detail,
      errorCode,
  ...
  return withRouteObservability(
    ...
    async () => {
      ...
      try {
        ...
        await permissionService.archivePermission(params.id, {
        ...
        logger.info('api.permissions.archive.succeeded', {
          status: 'success',
        ...
        logger.error('api.permissions.archive.failed', {
          status: 'failed',
        ...
        return problemJson(
          500,
          'Permission archive failed',
          'Unable to archive permission at this time.',
          'IAM-PERMISSIONS-ARCHIVE-FAILED',
        );
      }
    },
    { route: '/api/v1/permissions/:id/archive' },
