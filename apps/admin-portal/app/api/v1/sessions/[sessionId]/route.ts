...
function problemJson(
  ...
  return NextResponse.json(
    {
      type: 'https://ims.local/problems/session-terminate',
      title,
      status,
      detail,
      errorCode,
  ...
  return withRouteObservability(
    ...
    async () => {
      ...
      try {
        ...
        await sessionService.terminateSession(params.sessionId, {
        ...
        logger.info('api.sessions.terminate.succeeded', {
          status: 'success',
        ...
        logger.error('api.sessions.terminate.failed', {
          status: 'failed',
        ...
        return problemJson(
          500,
          'Session termination failed',
          'Unable to terminate session at this time.',
          'IAM-SESSION-TERMINATE-FAILED',
        );
      }
    },
    { route: '/api/v1/sessions/:sessionId' },
