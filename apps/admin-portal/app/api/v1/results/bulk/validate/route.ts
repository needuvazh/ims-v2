  ...
  return withRouteObservability(request.headers, async () =>
    withPermission(request, 'result.create', async ({ session }) => {
      ...
      try {
        ...
        const handler = new ValidateBulkResultsCommandHandler(resultRepository, examRepository);
        ...
        logger.error('api.results.bulk.validate.failed', { status: 'failed', error: error as Error });
