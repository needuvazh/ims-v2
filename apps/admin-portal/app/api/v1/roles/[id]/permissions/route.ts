...
function problemJson(
  ...
  return NextResponse.json(
    {
      type: 'https://ims.local/problems/role-permissions',
      title,
      status,
      detail,
      errorCode,
  ...
  return withRouteObservability(
    ...
    async () => {
      ...
      try {
        ...
        logger.info('api.roles.permissions.list.succeeded', {
          status: 'success',
          roleId: params.id,
        });
        return response;
        ...
        logger.error('api.roles.permissions.list.failed', {
          status: 'failed',
        ...
        return problemJson(
          500,
          'Role permissions failed',
          'Unable to load role permissions at this time.',
          'IAM-ROLE-PERMISSIONS-FAILED',
        );
      }
    },
    { route: '/api/v1/roles/:id/permissions' },
    ...
    async () => {
      ...
      try {
        ...
        return problemJson(
          ...
          'IAM-VAL-ROLE-PERMISSION-INVALID_JSON',
        );
      }
      ...
      if (!parsed.success) {
        return problemJson(
          400,
          'Invalid request body',
          'Permission assignment is invalid.',
          'IAM-VAL-ROLE-PERMISSION-INVALID_BODY',
      ...
      try {
        ...
        logger.info('api.roles.permissions.assign.succeeded', {
          status: 'success',
          roleId: params.id,
        ...
        logger.error('api.roles.permissions.assign.failed', {
          status: 'failed',
          error: error as Error,
          roleId: params.id,
        });
        return problemJson(
          500,
          'Permission assignment failed',
          'Unable to assign permission at this time.',
          'IAM-ROLE-PERMISSION-ASSIGN-FAILED',
        );
      }
    },
    { route: '/api/v1/roles/:id/permissions' },
