...
function problemJson(
  ...
  return NextResponse.json(
    {
      type: 'https://ims.local/problems/role-permission-remove',
      title,
      status,
      detail,
      errorCode,
  ...
  return withRouteObservability(
    ...
    async () => {
      ...
      try {
        ...
        logger.info('api.roles.permissions.remove.succeeded', {
          status: 'success',
          roleId: params.id,
        ...
        logger.error('api.roles.permissions.remove.failed', {
          status: 'failed',
        ...
        return problemJson(
          500,
          'Permission removal failed',
          'Unable to remove permission at this time.',
          'IAM-ROLE-PERMISSION-REMOVE-FAILED',
        );
      }
    },
    { route: '/api/v1/roles/:id/permissions/:permissionId' },
