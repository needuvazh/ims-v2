...
function problemJson(
  ...
  return NextResponse.json(
    {
      type: 'https://ims.local/problems/role-archive',
      title,
      status,
      detail,
      errorCode,
  ...
  return withRouteObservability(
    ...
    async () => {
      ...
      try {
        ...
        await roleService.archiveRole(params.id, {
        ...
        logger.info('api.roles.archive.succeeded', {
          status: 'success',
          roleId: params.id,
        });
        return response;
        ...
        logger.error('api.roles.archive.failed', {
          status: 'failed',
        ...
        return problemJson(
          500,
          'Role archive failed',
          'Unable to archive role at this time.',
          'IAM-ROLES-ARCHIVE-FAILED',
        );
      }
    },
    { route: '/api/v1/roles/:id/archive' },
