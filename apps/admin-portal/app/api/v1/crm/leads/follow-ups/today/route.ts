    ...
    async () =>
      withPermission(request, 'lead.read', async ({ session }) => {
        ...
        try {
          ...
          // Counselor scoping: only see their own assigned leads' followups unless they have read-all permission
          ...
          applyObservabilityResponseHeaders(response.headers, request.headers, {
            route: '/api/v1/crm/leads/follow-ups/today',
          ...
          logger.error('api.crm.leads.followups.today.failed', {
            status: 'failed',
