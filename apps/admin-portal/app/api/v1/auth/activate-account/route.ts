  ...
  return withRouteObservability(
    ...
    async () => {
      ...
      try {
        ...
        logger.info('api.auth.activateAccount.succeeded', {
          status: 'success',
        });
        return response;
      } catch (error) {
        ...
        logger.error('api.auth.activateAccount.failed', {
          status: 'failed',
        ...
        return problemJson(
          500,
          'Activation failed',
          'Unable to activate the account at this time.',
          'IAM-AUTH-ACTIVATE-FAILED',
        );
      }
    },
    { route: '/api/v1/auth/activate-account' },
