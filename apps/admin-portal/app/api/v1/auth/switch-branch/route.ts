  ...
  return withRouteObservability(
    ...
    async () => {
      ...
      try {
        ...
        await branchAccessService.switchActiveBranch(
          session.accessTokenJti,
          parsed.data.branchId as Uuid,
          session.userId,
        );
        ...
        response.cookies.set(
          sessionCookieName,
          await encodeSession(updatedSession),
          {
            httpOnly: true,
        ...
        logger.info('api.auth.switchBranch.succeeded', {
          status: 'success',
        ...
        logger.error('api.auth.switchBranch.failed', {
          status: 'failed',
        ...
        return problemJson(
          500,
          'Branch switch failed',
          'Unable to switch branch at this time.',
          'IAM-AUTH-SWITCH-FAILED',
        );
      }
    },
    { route: '/api/v1/auth/switch-branch' },
