...
export default function StudentSignInPage() {
  ...
  return (
    <PortalAuthLayout
        ...
        <PortalAuthHeroPanel
          ...
          body={
            <>
              <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1.5 backdrop-blur-sm">
                ...
                <span className="text-xs font-bold uppercase tracking-widest text-[#f8e8d7]">Student Portal</span>
              </div>

              <h1 className="mb-6 text-5xl font-black leading-[1.1] xl:text-7xl">
                Learn. <br />
                <span className="text-[#f4d5b7]">Grow.</span><br />
                Achieve.
              </h1>
          ...
          footer={
            <div className="flex items-center gap-4">
              ...
              <p className="text-sm font-bold text-[#f8e8d7]">Join 25,000+ students</p>
            </div>
          }
        />
      }
      ...
      topBar={
        <>
          <Link href="/student" className="group flex items-center gap-2 text-xs font-bold text-slate-500 transition-colors hover:text-[#b75c16]">
    ...
    >
      <div className="mb-10 text-center">
        ...
        >
          <BookOpen className="h-8 w-8 text-[#b75c16]" />
        </motion.div>
