...
export default function StudentSignInPage() {
  ...
  return (
    <PortalAuthLayout
        ...
        <PortalAuthHeroPanel
          ...
          decoration={
            <motion.div
              ...
              className="absolute -top-[20%] -left-[10%] h-[800px] w-[800px] rounded-full bg-yellow-400/30 blur-[100px]"
            />
          }
          header={
            <Link href="/student" className="inline-flex items-center gap-3 group">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white text-pink-600 shadow-xl transition-transform group-hover:rotate-12">
          ...
          body={
            <>
              ...
              <p className="max-w-md text-lg text-pink-100">
      ...
      topBar={
        <>
          <Link href="/student" className="group flex items-center gap-2 text-xs font-bold text-slate-500 transition-colors hover:text-pink-600">
            <div className="rounded-full bg-slate-100 p-2 transition-colors group-hover:bg-pink-100">
    ...
    >
      <div className="mb-10 text-center">
        <motion.div
          ...
          className="mx-auto mb-6 flex h-16 w-16 rotate-3 items-center justify-center rounded-3xl border border-pink-200 bg-pink-100 shadow-inner"
        >
      ...
      <form onSubmit={handleSubmit} noValidate className="space-y-5">
        <div className="space-y-1.5">
          ...
          <div className="relative group">
            <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4">
              <Mail className="h-5 w-5 text-slate-400 transition-colors group-focus-within:text-pink-500" />
            </div>
            <input
              type="email"
        ...
        <div className="space-y-1.5">
          <div className="ml-1 flex items-center justify-between">
            ...
            <a href="#" className="text-xs font-bold text-pink-600 transition-colors hover:text-rose-600">Forgot?</a>
          </div>
          <div className="relative group">
            <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4">
              <Lock className="h-5 w-5 text-slate-400 transition-colors group-focus-within:text-pink-500" />
            </div>
            <input
            ...
            <button
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 rounded-xl p-2 text-slate-400 transition-colors hover:bg-pink-50 hover:text-pink-600"
            >
        ...
        <motion.button
          ...
          type="submit"
          disabled={isPending}
          className="mt-6 flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-pink-600 to-rose-500 py-4 text-sm font-bold text-white shadow-lg shadow-pink-500/30 transition-all disabled:opacity-70"
        >
          {isPending ? (
