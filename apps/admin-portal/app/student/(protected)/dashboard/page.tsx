...
export default function StudentDashboardPage() {
  ...
  const upcomingEvents = [
    {
      title: 'Process Safety Quiz (Unit 3)',
      time: 'Today, 10:00 AM',
      type: 'Quiz',
      color: 'text-primary-700 bg-brand-50',
    },
    {
      title: 'Risk Assessment Lab Practical',
      time: 'Tomorrow, 02:00 PM',
      type: 'Practical',
      color: 'text-accent-700 bg-accent-50',
    },
    {
      title: 'Mid-term Mock Examination',
      time: 'July 5, 09:00 AM',
      type: 'Exam',
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div className="space-y-2">
            ...
            <p className="text-sm text-slate-300 font-medium">
              Keep progressing on your target milestones. You have 2 active
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div className="space-y-1">
                      <span
                        className={`inline-block px-2.5 py-0.5 rounded-lg text-[10px] font-bold uppercase tracking-widest ${course.tagColor}`}
                      >
                        {course.code}
                      </span>
                  ...
                  <div className="mt-6 space-y-2">
                    <div className="flex justify-between text-xs font-bold text-slate-600">
                      ...
                      <span>
                        {course.progress}% Completed ({course.completedClasses}/
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Installment schedule & outstanding balance dues.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="rounded-2xl bg-rose-50/50 border border-rose-100 p-5 text-center space-y-2">
                ...
                <p className="text-[10px] font-semibold text-rose-600">
                  Next Installment due by June 30, 2026
                </p>
              </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Upcoming quizzes, assignments, and test schedules.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {upcomingEvents.map((evt, i) => (
                ...
                >
                  <div
                    className={`px-3 py-1.5 rounded-xl font-bold text-xs uppercase tracking-wider text-center shrink-0 ${evt.color}`}
                  >
                    {evt.type}
                  </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Earned credentials and eligibility track.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex gap-4 p-4 rounded-2xl border border-dashed border-slate-200 text-center flex-col items-center">
                ...
                <Link href="/student/certificates" className="w-full">
                  <Button
                    variant="outline"
                    className="w-full py-2.5 rounded-xl text-xs font-bold border-slate-300 text-slate-700 hover:bg-slate-50 transition-colors"
                  >
                    Claim Certificate
                  </Button>
                </Link>
