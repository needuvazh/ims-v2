...
export function PublicShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-surface-50 text-neutral-900 font-sans selection:bg-accent-500 selection:text-white">
      ...
      {/* Main Header */}
      <header
        className={`sticky top-0 z-50 transition-all duration-300 ${scrolled ? 'bg-primary-900/90 backdrop-blur-xl border-b border-white/10 shadow-lg shadow-primary-950/20 py-4' : 'bg-primary-900 py-6 border-b border-white/5'}`}
      >
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden items-center gap-3 lg:flex">
            <Link
              href="/contact-us"
              className="inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-accent-600 to-accent-500 px-6 py-2.5 text-[11px] font-bold uppercase tracking-[0.15em] text-white shadow-lg shadow-accent-600/20 transition-transform hover:-translate-y-0.5"
            >
              Book Now
            ...
            >
              <div className="mx-auto flex flex-col px-4 py-6">
                ...
                <Link
                  href="/contact-us"
                  onClick={() => setMobileOpen(false)}
                  className="mt-6 inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-accent-600 to-accent-500 py-4 text-sm font-bold uppercase tracking-[0.15em] text-white shadow-lg shadow-accent-600/20"
                >
                  Book Now
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4 text-sm text-neutral-400">
              <p className="flex items-start gap-4">
                <MapPin className="mt-1 h-4 w-4 shrink-0 text-accent-400" />{' '}
                {contactInfo.address}
              </p>
    ...
    <section className="relative flex items-center justify-center overflow-hidden bg-primary-900 py-hero-py">
      ...
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center px-4 text-center sm:px-6 lg:px-8">
        ...
        >
          <Link
            href={primaryHref}
            className="inline-flex items-center justify-center gap-3 rounded-full bg-gradient-to-r from-accent-600 to-accent-500 px-8 py-4 text-[13px] font-bold uppercase tracking-[0.15em] text-white shadow-xl shadow-accent-600/20 transition-transform hover:-translate-y-1"
          >
            {primaryLabel}
            <ArrowRight className="h-4 w-4" />
          </Link>
          <Link
            href={secondaryHref}
            className="inline-flex items-center justify-center gap-3 rounded-full border border-white/20 bg-white/5 px-8 py-4 text-[13px] font-bold uppercase tracking-[0.15em] text-white backdrop-blur-md transition-all hover:bg-white/10 hover:border-white/30"
          >
            {secondaryLabel}
          </Link>
        </motion.div>
          ...
          >
            {heroStats.map((item) => {
              ...
              return (
                <div
                  key={item.label}
                  className="group relative flex flex-col items-center justify-center overflow-hidden rounded-[1.5rem] bg-primary-900/90 px-6 py-10"
                >
  ...
  return (
    <div className="relative overflow-hidden rounded-[3rem] bg-primary-900 px-page-px py-hero-py text-center shadow-2xl">
      ...
      <div className="relative z-10 mx-auto max-w-3xl">
        ...
        <h3 className="mt-6 font-display text-hero-title font-bold text-white">
          {title}
        </h3>
        ...
        <Link
          href={href}
          className="mt-10 inline-flex items-center justify-center gap-3 rounded-full bg-white px-8 py-4 text-[13px] font-bold uppercase tracking-[0.15em] text-primary-900 transition-all hover:-translate-y-1 hover:bg-surface-200 hover:shadow-xl hover:shadow-white/10"
        >
          {label}
          <ArrowRight className="h-4 w-4" />
        </Link>
