...
const FEATURES = [
  {
    ...
    desc: 'View schedule, update topics, and manage room allocations.',
    icon: ClipboardCheck,
  },
  {
    title: 'Content Upload',
    desc: 'Share presentations, notes, and study materials.',
    icon: Video,
  },
  {
    title: 'Attendance',
    desc: 'Track and mark student attendance effortlessly.',
    icon: Users,
  },
  {
    title: 'Assessments',
    desc: 'Grade assignments and provide feedback to students.',
    icon: CheckCircle,
  },
];
    ...
    <div className="min-h-screen bg-surface-200 font-sans overflow-hidden text-neutral-900">
        ...
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <span className="font-black text-lg tracking-tight">
              Trainer<span className="text-accent-700">Portal</span>
            </span>
          </Link>
          <Link
            href="/trainer/sign-in"
            className="px-6 py-2.5 rounded-xl bg-primary-900 text-white text-sm font-bold hover:bg-accent-600 transition-colors shadow-md hover:shadow-accent-600/25"
          >
            Trainer Login
          </Link>
        </div>
        ...
        <div className="max-w-5xl mx-auto flex flex-col lg:flex-row items-center gap-16 relative z-10">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-neutral-500 mb-10 max-w-xl mx-auto lg:mx-0">
              Manage your sessions, interact with students, and deliver
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              <Link
                href="/trainer/sign-in"
                className="w-full sm:w-auto px-8 py-4 rounded-xl bg-gradient-to-r from-primary-700 to-accent-600 text-white font-bold text-lg flex items-center justify-center gap-2 shadow-xl shadow-primary-700/25 hover:scale-105 transition-transform"
              >
          ...
          >
            ...
            >
              <div className="bg-accent-50 p-2 rounded-lg text-accent-700">
            ...
            >
              <div className="bg-white/10 p-2 rounded-lg text-accent-200">
                <Users className="w-5 h-5" />
              </div>
              <div>
                <p className="text-sm font-bold">
                  <CountUp value="45+" /> Students
                </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-neutral-500 max-w-2xl mx-auto">
              Everything you need to run your classes smoothly and efficiently.
            </p>
          </div>
      ...
      <section className="py-20 bg-primary-900 text-white text-center">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <Link
            href="/trainer/sign-in"
            className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-white text-primary-900 font-bold hover:bg-accent-50 transition-colors shadow-lg shadow-white/10"
          >
