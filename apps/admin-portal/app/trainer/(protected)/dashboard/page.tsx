...
export default function TrainerDashboardPage() {
  const stats = [
    ...
    },
    {
      ...
      value: '2',
      description: 'Batch approvals pending',
  ...
  const activeBatches = [
    ...
    {
      code: 'SF-203-B',
      name: 'Industrial Risk Assessment',
      students: 12,
      maxStudents: 15,
      status: 'Active',
    },
    {
      code: 'NEB-402-C',
      name: 'NEBOSH Safety Authorization',
      students: 25,
      maxStudents: 25,
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div className="space-y-2">
            ...
            <p className="text-sm text-slate-300 font-medium">
              You have 2 upcoming teaching sessions scheduled for today. Review
              the attendance grids below.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 self-start md:self-auto rounded-2xl bg-white/5 border border-white/10 p-3.5 backdrop-blur-md">
            ...
            <div>
              ...
              <p className="text-xs font-black text-accent-200">
                HIGH ENGAGEMENT
              </p>
            </div>
          </div>
        ...
        {stats.map((stat, i) => (
          ...
          >
            <div className="space-y-1">
              <p className="text-xs font-bold uppercase tracking-wider text-[color:var(--ims-muted)]">
                {stat.title}
              </p>
              <p className="text-3xl font-black text-[color:var(--ims-ink)]">
                {stat.value}
              </p>
              <p className="text-[10px] text-[color:var(--ims-muted)] font-medium">
                {stat.description}
              </p>
            </div>
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Management of your assigned batches and student logs.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {activeBatches.map((batch) => (
                <div
                  key={batch.code}
                  className="flex flex-col gap-2 p-4 rounded-2xl border border-slate-100 bg-slate-50/50"
                >
                  ...
                  <div className="flex items-center justify-between text-[10px] text-slate-500 font-bold pt-2 border-t border-slate-100">
                    <span>
                      Capacity: {batch.students}/{batch.maxStudents}
                    </span>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Rules and guidelines for training delivery.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-3.5 text-xs text-[color:var(--ims-muted)] leading-relaxed">
              <div className="flex items-start gap-2.5">
                ...
                <span>
                  Attendance must be marked within 24 hours of class completion.
                </span>
              </div>
              <div className="flex items-start gap-2.5">
                <CheckCircle2 className="h-4 w-4 text-emerald-500 shrink-0 mt-0.5" />
                <span>
                  Submit course completion recommendations directly to the
                  Branch Manager for certificate eligibility audit.
                </span>
              </div>
            </CardContent>
          </Card>
