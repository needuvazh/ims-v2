      ...
      <div className="grid gap-4 lg:grid-cols-[1.4fr_1fr]">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Use this page as the operational entry point for manual attendance
              in Phase 1.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
            {steps.map((step, index) => (
              <div
                key={step}
                className="flex gap-3 rounded-xl border border-[color:var(--ims-border)] p-3"
              >
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              All access is checked on the server.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3 text-sm text-[color:var(--ims-muted)]">
            ...
            <p>
              Attendance evidence is shared with completion review, but
              completion remains external to Attendance.
            </p>
          </CardContent>
        </Card>
      </div>
