          ...
          body={
            <>
              ...
              <h1 className="mb-6 text-5xl font-black leading-[1.1] xl:text-7xl">
                Teach. <br />
                <span className="text-accent-200">Inspire.</span>
                <br />
                Lead.
              </h1>

              <p className="max-w-md text-lg text-accent-50/85">
                Your centralized workspace for managing classes, sharing
                content, and tracking student success.
              </p>
            </>
          }
          footer={
    ...
    >
      <div className="mb-10 text-center">
        ...
        <p className="text-sm text-slate-500">
          Secure access to your teaching tools.
        </p>
      </div>
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative group">
            ...
            <input
              ...
              aria-describedby={
                fieldErrors.email ? 'trainer-email-error' : undefined
              }
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative group">
            ...
            <input
              ...
              aria-describedby={
                fieldErrors.password ? 'trainer-password-error' : undefined
              }
