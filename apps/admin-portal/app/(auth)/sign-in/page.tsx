...
export default function SignInPage() {
  ...
  return (
    <PortalAuthLayout
          ...
          body={
            <>
              ...
              <h1 className="mb-6 text-5xl font-black leading-[1.1] xl:text-7xl">
                Manage. <br />
                <span className="bg-gradient-to-r from-violet-300 via-fuchsia-300 to-cyan-300 bg-clip-text text-transparent">Empower.</span><br />
                Succeed.
              </h1>
      ...
      topBar={
        <>
          <Link href="/" className="group flex items-center gap-2 text-xs font-bold text-slate-500 transition-colors hover:text-violet-600">
    ...
    >
      ...
      <form action={formAction} onSubmit={handleSubmit} noValidate className="space-y-5">
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative group">
            <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4">
              <Lock className="h-5 w-5 text-slate-400 transition-colors group-focus-within:text-violet-500" />
            </div>
            <input
              id="si-password"
              name="password"
            ...
            <button
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 rounded-xl p-2 text-slate-400 transition-colors hover:bg-violet-50 hover:text-violet-600"
            >
        ...
        <label className="group ml-1 flex w-fit cursor-pointer items-center gap-3 text-sm text-slate-600">
          <div className="relative flex h-5 w-5 items-center justify-center rounded border-2 border-slate-300 transition-colors group-hover:border-violet-500">
            ...
            <CheckCircle2 className="h-4 w-4 text-violet-600 opacity-0 transition-opacity peer-checked:opacity-100" />
          </div>
