...
import {
  parseActivateAccountFieldErrors,
  type ActivateAccountFieldErrors,
} from './schema';
...
export function ActivateAccountForm({ token = '' }: { token?: string }) {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    const errors = parseActivateAccountFieldErrors(
          ...
          body={
            <>
              ...
              <p className="mb-8 max-w-md text-lg text-accent-50/80">
                ...
                setup and begin using the portal.
              </p>
    ...
    >
      <div className="mb-10 text-center">
        ...
        <p className="text-sm text-slate-500">
          Paste the activation token from your email to finish setup.
        </p>
      </div>
          ...
          >
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  aria-describedby={
                    fieldErrors.token ? 'aa-token-error' : undefined
                  }
            ...
            >
              {isPending ? (
                ...
                <>
                  Activate Account <ChevronRight className="h-4 w-4" />
                </>
              )}
            </motion.button>
          </motion.form>
