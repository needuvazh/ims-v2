  ...
  return withServerActionObservability(
    async () => {
      ...
      try {
        ...
        logger.info('iam.securityPolicy.updated', {
          status: 'success',
        ...
        if (error instanceof DomainError) {
          logger.warn('iam.securityPolicy.update.failed', {
            status: 'failed',
        ...
        logger.error('iam.securityPolicy.update.failed', {
          status: 'failed',
