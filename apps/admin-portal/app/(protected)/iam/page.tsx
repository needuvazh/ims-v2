...
const sections = [
  {
    href: '/iam/users',
    title: 'Users',
    description: 'Create, update, activate, suspend, and assign access.',
    icon: Users,
  },
  {
    href: '/iam/roles',
    title: 'Roles',
    description: 'Maintain roles and permission assignments.',
    icon: ShieldPlus,
  },
  {
    href: '/iam/permissions',
    title: 'Permissions',
    description: 'Review the approved IAM permission catalog.',
    icon: KeyRound,
  },
  {
    href: '/iam/sessions',
    title: 'Sessions',
    description: 'Inspect active sessions and enforce sign-out.',
    icon: Clock3,
  },
  {
    href: '/iam/login-history',
    title: 'Login History',
    description: 'Browse sign-in attempts and lockouts.',
    icon: Clock3,
  },
  {
    href: '/iam/security-policy',
    title: 'Security Policy',
    description: 'Tune password, lockout, and session policy.',
    icon: ShieldCheck,
  },
  {
    href: '/iam/audit',
    title: 'Audit',
    description: 'Review immutable security and branch audit events.',
    icon: ShieldAlert,
  },
  {
    href: '/iam/reports',
    title: 'Reports',
    description: 'Open IAM report views and export jobs.',
    icon: LayoutDashboard,
  },
  {
    href: '/iam/reports/export-jobs',
    title: 'Export Jobs',
    description: 'Track report export status and downloads.',
    icon: FileClock,
  },
  {
    href: '/iam/dashboards',
    title: 'Dashboards',
    description: 'Track security and compliance KPIs.',
    icon: LayoutDashboard,
  },
];
