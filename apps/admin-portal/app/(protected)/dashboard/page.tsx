...
export default async function DashboardPage() {
  ...
  const mockActivities = [
    {
      type: 'auth',
      message: 'Super Admin logged in successfully from Muscat IP',
      time: '2 mins ago',
      icon: ShieldCheck,
    ...
    {
      type: 'org',
      message: 'Branch "Muscat Campus" status changed to Active',
      time: '1 hour ago',
      icon: Building2,
    ...
    {
      type: 'dept',
      message: 'Department "Safety Engineering" created under Riyadh Branch',
      time: '3 hours ago',
      icon: BookOpen,
    ...
    {
      type: 'audit',
      message: 'Audit log appended for action: organization.institute_created',
      time: '5 hours ago',
      icon: Activity,
      color: 'text-primary-600 bg-primary-500/10',
    },
  ];
  ...
  const quickLinks = [
    {
      ...
      desc: 'Add new corporate entity',
      href: '/organization',
      icon: Building2,
      color: 'from-primary-700 to-brand-500',
    },
    {
      title: 'Manage Branches',
      desc: 'Configure regional campuses',
      href: '/organization',
      icon: BookOpen,
    ...
    },
    {
      ...
      desc: 'Organize training divisions',
      href: '/organization',
      icon: GraduationCap,
      color: 'from-brand-500 to-primary-700',
    },
    {
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div className="space-y-2">
            ...
            <p className="text-sm text-neutral-300 font-medium">
              Here is the live operations and compliance summary for Al-Saud
              Training Institute today.
            </p>
          </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Shortcut access to organizational setup and IAM controls.
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {quickLinks.map((link) => {
                  ...
                  return (
                    <Link
                      key={link.title}
                      href={link.href}
                      className="group relative block rounded-xl border border-white/60 bg-white/60 backdrop-blur-xl p-5 transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
                    >
                      <div className="flex items-center gap-4">
                        <div
                          className={`flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br ${link.color} text-white shadow-md transition-transform duration-300 group-hover:scale-110`}
                        >
                ...
                {summary.institutes.map((inst) => (
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between gap-3 relative z-10">
                      ...
                      <Badge
                        variant={inst.status === 'Active' ? 'success' : 'muted'}
                      >
                        {inst.status}
                      </Badge>
                    </div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Reliable domain event bus and transactional outbox logs.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="rounded-xl bg-muted-50 border border-border-light p-4 space-y-3">
                ...
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className="font-mono bg-muted-200 text-neutral-700 px-1.5 py-0.5 rounded text-[10px]">
                    8472
                  </span>
                </div>
              </div>
              <div className="flex items-center gap-2 text-xs text-[color:var(--ims-muted)] leading-relaxed">
                ...
                <span>
                  All pending database outbox transactions verified cleanly.
                </span>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Live action history captured inside this branch scope.
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {mockActivities.map((act, i) => {
                  ...
                  return (
                    <div key={i} className="relative space-y-1">
                      <div
                        className={`absolute -left-[25px] top-0 rounded-full p-1 border-2 border-white shadow-sm ${act.color}`}
                      >
