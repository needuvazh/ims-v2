...
import {
  buildOrganizationActionFailure,
  extractFormValues,
} from './organization-form-errors';
  ...
  return withServerActionObservability(
    async () => {
      ...
      try {
        ...
        await organizationService.createInstitute(
          {
            ...
            effectiveStartDate:
              startStr && startStr.trim() !== '' ? new Date(startStr) : null,
            effectiveEndDate:
              endStr && endStr.trim() !== '' ? new Date(endStr) : null,
        ...
        logger.info('organization.institute.create.succeeded', {
          status: 'success',
        });
        revalidatePath('/organization');
        return { success: true };
      } catch (err) {
        logger.warn('organization.institute.create.failed', {
          status: 'failed',
  ...
  return withServerActionObservability(
    async () => {
      ...
      try {
        ...
        await organizationService.updateInstitute(
          instituteId,
          {
            instituteName: String(formData.get('instituteName') ?? ''),
            registrationNumber: emptyToNull(formData.get('registrationNumber')),
        ...
        logger.info('organization.institute.update.succeeded', {
          status: 'success',
        ...
        logger.warn('organization.institute.update.failed', {
          status: 'failed',
          message: err instanceof Error ? err.message : 'unknown',
          error: err instanceof Error ? err : undefined,
        });
  ...
  return withServerActionObservability(
    async () => {
      ...
      try {
        ...
        logger.info('organization.branch.create.succeeded', {
          status: 'success',
        });
        revalidatePath('/organization');
        return { success: true };
      } catch (err) {
        logger.warn('organization.branch.create.failed', {
          status: 'failed',
          message: err instanceof Error ? err.message : 'unknown',
          error: err instanceof Error ? err : undefined,
        });
        const failure = buildOrganizationActionFailure(
          ...
          values,
          {
            ...
            prismaMessages: {
              branchCode:
                'Branch Code already exists. Please use a different Branch Code.',
            },
          },
        );
        return { success: false, ...failure };
  ...
  return withServerActionObservability(
    async () => {
      ...
      try {
        ...
        logger.info('organization.branch.update.succeeded', {
          status: 'success',
          entityId: branchId,
        });
        revalidatePath('/organization');
        ...
        logger.warn('organization.branch.update.failed', {
          status: 'failed',
          message: err instanceof Error ? err.message : 'unknown',
          error: err instanceof Error ? err : undefined,
        });
  ...
  return withServerActionObservability(
    async () => {
      ...
      try {
        ...
        logger.info('organization.department.create.succeeded', {
          status: 'success',
        });
        revalidatePath('/organization');
        return { success: true };
      } catch (err) {
        logger.warn('organization.department.create.failed', {
          status: 'failed',
          message: err instanceof Error ? err.message : 'unknown',
          error: err instanceof Error ? err : undefined,
        });
        const failure = buildOrganizationActionFailure(
          ...
          values,
          {
            ...
            prismaMessages: {
              departmentCode:
                'Department Code already exists in this branch. Please use a different Department Code.',
            },
          },
        );
        return { success: false, ...failure };
  ...
  return withServerActionObservability(
    async () => {
      ...
      try {
        ...
        logger.info('organization.department.update.succeeded', {
          status: 'success',
        ...
        logger.warn('organization.department.update.failed', {
          status: 'failed',
          message: err instanceof Error ? err.message : 'unknown',
          error: err instanceof Error ? err : undefined,
        });
  ...
  return withServerActionObservability(
    async () => {
      ...
      try {
        ...
        logger.info('organization.classroom.create.succeeded', {
          status: 'success',
        });
        revalidatePath('/organization');
        return { success: true };
      } catch (err) {
        logger.warn('organization.classroom.create.failed', {
          status: 'failed',
          message: err instanceof Error ? err.message : 'unknown',
          error: err instanceof Error ? err : undefined,
        });
        const failure = buildOrganizationActionFailure(
          ...
          values,
          {
            ...
            prismaMessages: {
              classroomName:
                'Classroom Name already exists in this branch. Please use a different Classroom Name.',
            },
          },
        );
        return { success: false, ...failure };
  ...
  return withServerActionObservability(
    async () => {
      ...
      try {
        ...
        await organizationService.updateClassroom(
          classroomId,
          {
            classroomName: String(formData.get('classroomName') ?? ''),
            capacity,
        ...
        logger.info('organization.classroom.update.succeeded', {
          status: 'success',
        ...
        logger.warn('organization.classroom.update.failed', {
          status: 'failed',
          message: err instanceof Error ? err.message : 'unknown',
          error: err instanceof Error ? err : undefined,
        });
  ...
  return withServerActionObservability(
    async () => {
      ...
      try {
        ...
        const { organizationService } = await import('../../lib/runtime');
        const hierarchy =
          await organizationService.getOrganizationHierarchy(instituteId);
        ...
        logger.info('organization.hierarchy.get.succeeded', {
          status: 'success',
          entityId: instituteId,
        ...
        if (isDomainError(err)) {
          logger.warn('organization.hierarchy.get.failed', {
            status: 'failed',
            message: err.message,
            error: err,
          });
        ...
        logger.error('organization.hierarchy.get.failed', {
          status: 'failed',
