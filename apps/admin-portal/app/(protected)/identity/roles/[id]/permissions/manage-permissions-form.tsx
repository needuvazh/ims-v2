            ...
            {Object.entries(groupedPermissions)
              ...
              .map(([moduleCode, perms]) => (
                <div key={moduleCode} className="space-y-4">
                  <h3 className="text-lg font-semibold text-[color:var(--ims-ink)] capitalize border-b border-[color:var(--ims-border)] pb-2">
                    {moduleCode}
                  </h3>
                        ...
                        >
                          <div>
                            <div className="flex items-center gap-2">
                              <span className="font-mono text-xs text-[color:var(--ims-brass)] font-semibold">
                                {perm.permissionCode}
                              </span>
                            ...
                            <p className="text-xs text-[color:var(--ims-muted)] mt-1">
                              {perm.moduleCode} / {perm.featureCode} /{' '}
                              {perm.actionCode}
                            </p>
                            <p className="text-sm text-[color:var(--ims-ink)] mt-1">
                ...
                >
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <Badge
                        variant={perm.status === 'Active' ? 'success' : 'muted'}
                      >
                        {perm.status}
                      </Badge>
                    </div>
